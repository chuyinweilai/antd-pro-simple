...
app.model({ namespace: 'list', ...(require('/Users/Miku/Desktop/project/antd-pro-simple/src/models/list.js').default) });
...
app.model({ namespace: 'project', ...(require('/Users/Miku/Desktop/project/antd-pro-simple/src/models/project.js').default) });
